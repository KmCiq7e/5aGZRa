	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		if (code) {
			...
			n += `${separator}${sub1}=${encodeURIComponent(code)}&${sub2}=${sub2Info}&${sub3}=${sub3Info}_${sub3Lang1}&${sub4}=${sub4Info}`;
			o += `${separator}${sub1}=${encodeURIComponent(code)}&${sub2}=${sub2Info}&${sub3}=${sub3Info}_${sub3Lang2}&${sub4}=${sub4Info}`;
		}
