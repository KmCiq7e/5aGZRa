	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		if (code) {
			...
			n += `${separator1}${sub1}=${encodeURIComponent(code)}&${sub2}=${sub2Info}&${sub3}=${sub3Info}_${sub3Type1}&${sub4}=${sub4Info}`;
			o += `${separator2}${sub1}=${encodeURIComponent(code)}&${sub2}=${sub2Info}&${sub3}=${sub3Info}_${sub3Type2}&${sub4}=${sub4Info}`;
		}
