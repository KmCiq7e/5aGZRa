	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		if (code) {
			...
			n += separator + sub1 + "=" + encodeURIComponent(code) + "&" + sub2 + "=" + sub2Info + "&" + sub3 + "=" + sub3Info + "_" + sub3Type1;
			o += separator + sub1 + "=" + encodeURIComponent(code) + "&" + sub2 + "=" + sub2Info + "&" + sub3 + "=" + sub3Info + "_" + sub3Type2;
		}
